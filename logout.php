    ...
    <section class="row">
        <div class="col">
            ...
            if ($logOutDueToSessionExpiry) {
                ...
                echo '<a class="btn btn__primary btn-lg mt-4" href="/login.php" role="button">Log in again</a>';
            } else {
                echo '<p class="h1">Logout success</p>';
                echo '<a class="btn btn__primary btn-lg mt-4" href="/" role="button">Return to Home</a>';
            }
            ?>
        </div>
    </section>
